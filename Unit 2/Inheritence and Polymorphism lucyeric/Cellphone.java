...
public class Cellphone {
  ...
  */
  public int charge (double hours){
    ...
    if (newCharge > 100){  //Restricts battery to <= 100
      this.battery = 100;
    }
    else {
  ...
  */
  ...
  /**Calls someone. Doesn't really do much. Drains battery a little. Prints error message if battery is 0
  ...
  */
  ...
  /**Texts someone. Doesn't really do much. Drains battery a little. Prints error message if battery is 0
  ...
  */
  public int use (double hours){
    ...
    if (newBattery < 0){
      this.battery = 0;  //Restricts battery to be >=0 percent
    }
    else{
      this.battery = newBattery;
    }
