...
Description: this is a Vegetable class, and each object has the attributes name, calories, and weight. All accessor methods are created,
as well as a method to return the new number of calories in an eaten veggie, and one to return all attributes of the veg in a String.
*/
...
public class Vegetable {
   ...
   */
   ...
   @param weight the weight of the vegetable eaten in grams
